...
using PdvChallenge.API.Helpers.Extensions;
using PdvChallenge.API.Infrastructure.Repositories;

namespace PdvChallenge.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //DI/Ioc lifecycle for Repository
            services.AddTransient<IPdvRepository, PdvRepository>();
        }

        // This method gets called by the runtime. Using this method to configure the HTTP request pipeline.
